...
const questions = [
  {
    question:
      "Is the JavaScript programming language  server side, client side, or both?",
    choices: [
      "a. both",
      "b. client side",
      "c. server side",
  ...
  {
    question:
      "Which is the correct 'if' statement to excute code if 'x' is equal to 12",
    choices: [
      "a. if (x == 12)",
      "b. if x == 12",
      "c. if {x == 12}",
...
function checkAnswer(answer) {
  ...
  if (
    ...
    answerCheck.textContent =
      "Incorrect! Correct answer: " + questions[questionIndex].answer;
  }
